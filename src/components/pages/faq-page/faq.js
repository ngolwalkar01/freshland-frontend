    ...
    accordionData: [
      {
        ...
        content: 'Frakt kostar 59 SEK som utgångspunkt, oavsett var i landet du befinner dig. Beställningar över 699 SEK får gratis frakt: ^)'
      },
      {
        title: 'När levererar ni?',
        content: 'Vår leveransdag är onsdagar!'
      },
      {
        title: 'Behöver jag vara hemma på leveransdagen?',
        content: 'Nej, det behöver du inte. Om du har specifika önskemål om var chauffören ska placera dina varor kan du lämna ett meddelande till chauffören genom att klicka på länkens i ditt leverans-SMS och ange informationen där. Om du bor i ett flerfamiljshus men inte är hemma kan du ange din portkod så att chauffören kan leverera dina varor utanför din dörr. Har du angett ett telefonnummer när du gjorde din beställning kommer chauffören att försöka ringa dig. Om chauffören inte kan leverera dina varor kan en ny leverans bokas till senare under dagen eller dagen därpå.'
      },
      {
        title: 'Tar ni tillbaka dom tomma lådorna?',
        content: 'Nej, tyvärr har vi inte resurser för det just nu, men vi arbetar med att hitta en lösning så att vi kan återanvända lådorna i framtiden.'
      },
      {
      ...
      },
      {
        ...
        content: 'Ja, om ditt postnummer finns tillgängligt på vår hemsida. Detta kan du kontrollera i vår sökmotor över tillgängliga postnummer. Om vi levererar till ditt fritidshus anger du bara den adressen som leveringsadress.'
      }
    ]
  },
  {
    ...
    accordionData: [
      {
        ...
        content: 'Vi stänger för beställningar varje onsdag kl. 24.00.'
      },
      {
      ...
      },
      {
        ...
        content: 'Alla beställningar placerade inom samma cykel till samma adress kommer att levereras tillsammans. Du kan göra en ny beställning med de nya artiklarna du vill lägga till, så läggs dessa till i din befintliga beställning. Om du beställer via samma användare registrerar systemet två leveranser till samma person men tar endast ut fraktavgift för en av dem (gratis frakt över 699kr). Om du beställer som “gäst” – utan en användare på hemsidan – kan du ändå få in båda beställningarna utan att betala dubbel frakt. Kontakta oss antingen via telefon eller e-post; vårt kundserviceteam hjälper dig gärna.'
      },
      {
        title: 'Vad gör jag om jag beställer nu men vill ha mina varor längre fram?',
        content: 'Vid kassan kan du välja mellan två olika leveransdagar. Som utgångspunkt är det möjligt att få beställningar veckan efter eller ca tio dagar senare. Vi kan dock inte leverera två veckor eller senare på grund av vårt koncept.'
      },
      {
    ...
    accordionData: [
      {
        ...
        content: 'Du kan läsa om det bästa sätt att förvara dina produkter på och hållbarheten för dessa på respektive produktsidan.'
      },
      {
    ...
    accordionData: [
      {
        ...
        content: 'Majoriteten av våra produkter är ekologiska. Du känner igen dessa genom eko-certifieringen. <br /><img decoding="async" class="alignnone wp-image-78411 size-full" src="https://fresh.land/wp-content/uploads/2020/02/EU-bio-e1582893883442.jpg" alt="" width="150" height="100"><br /> Våra icke-ekologiska produkter kallar vi Deluxe och är utvalda utifrån hög kvalitet och gårdens värden. Deluxe-produkterna är naturligt odlade i den omfattning det är möjligt. De är inte ytbehandlade eller mognade genom artificiella mognadsprocesser, och vi testar produkterna för bekämpningsmedel innan skörd för att säkerställa att de inte innehåller några kemiska bekämpningsmedel.'
      },
      {
        title: 'Vad är skillnaden mellan era ekologiska varor och era Deluxe varor?',
        content: 'Skillnaden mellan våra ekologiska varor och vår Deluxe-varor är huruvida de kommer från en odlare med eko-certifiering eller inte. Certifieringen är en försäkran till dig som konsument om att inga kemiska bekämpningsmedel har använts. För en odlare som inte har eko-certifiering kan det bero på att denne behövt akutbehandla ett specifikt problem där naturliga metoder inte kunnat råda bot på problemet och odlaren riskerar att mista hela sin skörd. Det kan även bero på att odlaren inte haft råd att betala för en eko-certifiering men använder sig av naturliga metoder. Skillnaden för dig som konsument är alltså att eko-certifieringen ger dig en garanti på att produkten är ekologisk.'
      },
      {
        title: 'Varifrån kommer era produkter?',
        content: 'Vi eftersträvar att leverera europeiska varor under deras naturliga säsong. För närvarande kommer majoriteten från <ul><li>Spanien</li><li>Portugal</li><li>Danmark</li><li>Italien</li></ul> Vi letar hela tiden efter lokala specialiteter från Europa, så att vi under året ska kunna erbjuda spännande nyheter i vårt sortiment.'
      }
    ]
  },
  {
    ...
    accordionData: [
      ...
      },
      {
        ...
        content: 'Har du ris eller ros eller förslag på förändringar? Hör gärna av dig! Du kan mejla oss på <a href="mailto:hej@fresh.land">hej@fresh.land</a><br />Vi är tacksamma för dina åsikter!<br />Vänligen, Fresh.Land-teamet'
      }
    ]
  }
]
