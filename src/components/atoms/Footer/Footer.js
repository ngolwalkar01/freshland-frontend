            ...
            <div className={styles.footertextcontainer}>
              ...
              <div>
                ...
                <ul>
                  ...
                  <li><Link href="complaints">{hpt.complaint}</Link></li>
              ...
              <div>
                <p>{hpt.theLegal}</p>
                <ul>
                  <li><Link href="terms">{hpt.terms}</Link></li>
                  <li><Link href="personaldatapolicy">{hpt.personalData}</Link></li>
                  <li><Link href="right&withdrawals">{hpt.rightWithdraw}</Link></li>
                </ul>
